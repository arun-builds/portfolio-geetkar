        ...
        <div className="md:w-6xl min-h-screen md:mx-auto p-4  md:  md: border-yellow-500/10 flex flex-col max-md:items-center  gap-8">
            ...
            <div className="flex justify-around items-center gap-4  p-2">
                <div className="flex flex-col gap-8 ">
                    <UserProfile userImage={session?.user?.image || ""} name={session?.user?.name || ""} username={session?.user?.username || ""} />
                    <p className="italic">I am a music producer and I love to make music and money.</p>
                    <ProfileButtons />
                </div>
